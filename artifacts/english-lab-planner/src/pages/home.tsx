...
const quickPanels = [
  ...
  },
  {
    ...
    text: "Access the complete document with all strategies and examples.",
    button: "Open Full Document",
    href: "/strategies",
    external: true,
  },
];
        ...
        <div className="max-w-3xl">
          <div className="flex flex-wrap items-start gap-3">
            ...
            <span className="inline-flex items-center gap-2 rounded-full bg-blue-50 border border-blue-200 px-3 py-1.5 text-blue-800 font-bold text-xs mt-1">
              <FlaskConical className="h-3.5 w-3.5" /> SCIENCE VERSION
            </span>
          </div>
          ...
          <Card className="mt-8 rounded-xl bg-blue-50/70 border-blue-100 shadow-sm">
            <CardContent className="p-6 flex flex-wrap items-center gap-8">
              <div>
                ...
                <p className="text-xs text-slate-600 mt-1.5 leading-relaxed">Scan to open our WIDA<br />Language Support Generator (web app)</p>
              </div>
